...
每关引入一种新敌人。战斗深度（M1）机制已实现但待真人验收，关卡系统
（M3）房间推进已实现但首领和局内成长还没做。还没有经营层。
...
- 经营层、装备、职业、升级全都还没有。
- 没有音效。
- 首领是精英群占位，不是真正的分阶段首领——六关现在都能通关，
  但终点房打的是一波强化编成，不是 LEVEL_DESIGN 第八节设计的两阶段首领。
- 局内三选一成长（奖励房）还没做，六关目前只有战斗房和首领房两种。

## 下一步

见 [路线图](docs/ROADMAP.md)。当前在 **M1 · 战斗深度**：
机制全部实现，脚本实测通过，**等真人打三局验收**。
